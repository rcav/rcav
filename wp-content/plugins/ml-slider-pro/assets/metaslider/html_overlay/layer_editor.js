    ...
    $(function () {
        var layerEditor = {
            ...
            createNewLayer: function() {
                ...
                var content_wrap = $("<div class='content_wrap' />")
                                        .css({
                                            'height': '100%',
                ...
                layer_color_bg
                    .spectrum({
                        ...
                        change: function(color) {
                            $('.metaslider-active .content_wrap').css('background-color', color.toRgbString());
                        }
                    });
            ...
            makeLayerEditable: function(layer) {
                ...
                $('.content', layer)
                    ...
                    .focus(function() {
                        ...
                        $("#layerBgColor").spectrum("set", $('.content_wrap', layer).css('background-color'));
                    });
        ...
        $('.openLayerEditor').live('click', function(e) {
            ...
            var button = $(this);
            var width = parseInt(button.data('width'), 10) < 800 ? 800 : parseInt(button.data('width'), 10);

            var colorbox = jQuery.colorbox({
                html: layerEditor.render(button.data('thumb'), button.data('editor_id'), button.data('width'), button.data('height')),
                transition: "elastic",
                innerHeight: parseInt(button.data('height'), 10) + 142 + 'px',
                innerWidth: width + 'px',
                scrolling: true,
