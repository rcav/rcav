...
$header .= sprintf(
	...
	<table class="vfb-email-inner" cellspacing="0" border="0" cellpadding="0" width="100%%">
			...
			switch ( $field->field_type ) :
				case 'fieldset' :
					...
					$body .= sprintf(
						...
						<table class="vfb-email-fieldset" cellspacing="0" border="0" cellpadding="0" width="100%%">' . "\n",
