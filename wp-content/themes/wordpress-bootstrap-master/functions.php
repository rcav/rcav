...
function bones_register_sidebars() {
    ...
    register_sidebar(array(
    	'id' => 'sidebar2',
    	'name' => 'Homepage Editorial Blocks',
...
function bones_wpsearch( $form ) {
  ...
  <input type="submit" id="searchsubmit" value="'. esc_attr__('Go','bonestheme') .'" />
  </form>';
  return $form;
} // don't remove this bracket!
...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
        ...
        wp_register_style( 'bootstrap', get_template_directory_uri() . '/library/css/bootstrap.css', array(), NULL, 'all' );
        wp_register_style( 'bootstrap-responsive', get_template_directory_uri() . '/library/css/responsive.css', array(), NULL, 'all' );
        wp_register_style( 'wp-bootstrap', get_stylesheet_uri(), array(), NULL, 'all' );
...
// cleanup add this to theme filter
...
//  If you don't like the class prefixes I have chosen, you can change them here.
  ...
  if ( is_single() ) {
    ...
    if(!is_front_page($wp_query->post)) {
...
{
    echo '<style  type="text/css"> h1 a {  background-image:url(' . get_bloginfo('template_directory') . '/images/assets/logo.png)  !important; } </style>';
}
